...
vi.mock('../../src/components/InputTextField.vue', () => ({ default: { template: '<input @input="$emit(\'input\', $event)" />', props: ["modelValue"] } }))
vi.mock('../../src/store/globalstate', () => ({ refstorage: { get: vi.fn(), getValueType: vi.fn(), set: vi.fn() } }))
